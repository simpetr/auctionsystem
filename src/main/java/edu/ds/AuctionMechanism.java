...
public interface AuctionMechanism {
     ...
     */
    boolean createAuction(String _auction_name, Date _end_time, double _reserved_price, String _description);
    /**
     * Creates a new auction for a good with a "Buy it now" option.
     * @param _auction_name a String, the name identify the auction.
     * @param _end_time a Date that is the end time of an auction.
     * @param _reserved_price a double value that is the reserve minimum pricing selling.
     * @param _description a String describing the selling goods in the auction.
     * @param _buyNowPrice a double value that is the "buy now price". Must be greater than reserve price.
     * @return true if the auction is correctly created, false otherwise.
     */
    boolean createAuctionWithBuyNowOption(String _auction_name, Date _end_time, double _reserved_price, String _description, double _buyNowPrice);
     ...
     */
    String checkAuction(String _auction_name);
     ...
     * @return a String value that is the status of the auction.
     */
    String placeAbid(String _auction_name, double _bid_amount);

    /**
     * Use the "Buy it now" action on an auction
     * @param _auction_name a String, the name of the auction.
     * @return a String value that is the status of the auction.
     */
    String buyItNow(String _auction_name);

    /**
     * Deletes an auction which ended or has no bids
     * @param _auction_name a String, the name of the auction.
     * @return true if the auction is correctly deleted, false otherwise.
     */
    boolean deleteAuction(String _auction_name);
